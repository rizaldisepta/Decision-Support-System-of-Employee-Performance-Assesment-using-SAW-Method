...
class Rangking{
	...
	function readAll(){
		...
		$query = "SELECT * FROM ".$this->table_name." GROUP BY id_alternatif";
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
	...
	function readKhusus(){
		...
		$query = "SELECT * FROM alternatif a, kriteria b, rangking c where a.id_alternatif=c.id_alternatif and b.id_kriteria=c.id_kriteria and a.id_alternatif order by a.id_alternatif asc";
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
	 ...
	 function readAlternatif(){

		$query = "SELECT id_alternatif FROM rangking Group BY id_alternatif";
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
