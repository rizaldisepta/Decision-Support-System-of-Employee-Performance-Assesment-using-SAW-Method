...
?>
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            <button onclick="location.href='tambah_alternatif.php'" class="btn btn-primary">Tambah Data</button>
        </div>
    </div>
    <br/>
    ...
    <table width="100%" class="table table-striped table-bordered" id="tabeldata">
        <thead>
            <tr>
                <th width="25px">No</th>
                <th width="25px">Nama Alternatif</th>
                <th width="25px">Hasil Alternatif</th>
...
?>
            <tr>
                ...
                <td >
                    <a href="ubah_alternatif.php?id=<?php echo $row['id_alternatif'] ?>" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
