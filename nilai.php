...
?>
    ...
    <table  class="table table-striped table-bordered" id="tabeldata">
        <thead>
            <tr>
                <th width="25px">No</th>
                <th width="25px">Keterangan Nilai</th>
                <th width="25px">Jumlah Nilai</th>
...
?>
            <tr>
                ...
                <td >
                    ...
                    <a href="ubah_nilai.php?id=<?php echo $row['id_nilai'] ?>" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
